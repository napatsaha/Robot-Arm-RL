# -*- coding: utf-8 -*-
"""
Created on Fri May 12 20:55:41 2023
...
class DSACAgent:
    ...
    def critic_loss(self, states, actions, rewards, nextstates, done):
        ...
        pred_q1 = self.critic1.gather(states, actions).squeeze(-1)
        pred_q2 = self.critic2.gather(states, actions).squeeze(-1)
    ...
    def actor_loss(self, states):
        ...
        log_probs = torch.sum(probs * log_probs, dim=-1).mean(dim=-1)
