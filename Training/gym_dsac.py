# -*- coding: utf-8 -*-
"""
Created on Wed May 10 19:35:10 2023
...
class DSACAgent:
    ...
    def _initialise_model(self):
        ...
        # Actor network
        self.actor = ActorNetwork(self.n_states, self.n_actions, self.hidden_size)
        
        # Temperature (alpha)
        self.target_entropy = -torch.prod(torch.Tensor(self.n_actions)).item()
    ...
    def critic_loss(self, states, actions, rewards, nextstates, done):
        ...
        pred_q1 = self.critic1.gather(states, actions)
        pred_q2 = self.critic2.gather(states, actions)
    ...
    def actor_loss(self, states):
        ...
        log_probs = torch.sum(probs * log_probs, dim=1) #Very important difference to learning05_discretesac.py
